"""
Model-2 keywords x constants probe.

Runs model-2 across:
- keyword contexts derived from model-2 SVD token clusters
...
# Keywords inferred from earlier model-2 token clusters.
KEYWORDS = [
    "NONE",
    "acceptable",
    "satisfied",
...
async def main():
    ...
    out_path = f"probe_model2_keywords_constants_{stamp}.json"
